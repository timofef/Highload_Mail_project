...
4. attach
    ...
    Если считать средний размер аттача равным 
...
3. Users - отвечает за регистрацию и получение данных о пользователе.
4. Letters - отвечает за чтение писем из БД, запись писем в БД.
...
5. Постраничное получение списка последних писем
