...
1. Отправка писем:
    ...
    RPS для запросов на отправку писем равен 190. 90% из них не содержат вложений и весят в среднем по 4 кб, остальные 10% имеют вложения и весят в среднем 400 кб. Тогда:
    ```
...
2. Постраничное получение списка последних писем из почтового ящика:
