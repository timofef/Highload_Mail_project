...
Будем учитывать пиковое значение RPS пр расчете обрудования (в 3 раза больше сренего).
Также, будем считать, что сервер с 16 ядерным процессором может держать 4000 RPS. Тогда для для сервисов Auth
...
|-----------|---------|-----|-------|-------------|
|NGINX      |
|DNS        |8 cores  |8 GB |64 GB  |1 + 1 реплика|
|Auth       |16
|Users      |16
|Letters    |4 cores  |16 GB|64 GB  |1 + 2 реплики|
