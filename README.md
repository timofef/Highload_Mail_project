...
Будем учитывать пиковое значение RPS пр расчете обрудования. Также, на основании бенчмарка будем считать, что 16 ядерный сервер на golang способен обрабатывать 4000 запросов в секунду.
...
|База данных     | CPU cores|RAM|Storage|Num|
|----------------|----------|---|-------|---|
|Sessions Redis  |
|Users Redis     |
|Letters Postgres|
...
|   Сервис  |CPU cores|RAM|Storage|Num|
|-----------|---------|---|-------|---|
|NGINX      |
|DNS        |
|Auth       |16
