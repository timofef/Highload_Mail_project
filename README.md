...
Будем учитывать пиковое значение RPS при расчете обрудования (в 3 раза больше сренего). На основании бенчмарка будем считать, что бекенд на golang способен обрабатывать 3500 запросов в секунду.
...
По эмпирическим данным, rps для запросов на фронтенд будем считать равным 28000.
